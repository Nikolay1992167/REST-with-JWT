package by.it.restjwt.utils;

import by.it.restjwt.dto.ExceptionResponse;
import by.it.restjwt.dto.MessageResponse;
...
public class ResponseUtils {
    ...
    public static final String BAD_CREDENTIALS_EXCEPTION_MESSAGE = "Incorrect username or password!";
    ...
    public static List<String> getErrorValidationResponse(MethodArgumentNotValidException exception) {
